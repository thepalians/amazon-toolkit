...
import { FiGrid, FiDollarSign, FiSearch, FiEdit3, FiEye, FiCreditCard, FiShoppingCart, FiKey, FiCheckSquare, FiBell, FiPackage, FiTrendingUp, FiMessageSquare, FiBox, FiTruck, FiTarget, FiLayers, FiFileText, FiUsers, FiLink, FiBook, FiMessageCircle, FiNavigation, FiGlobe, FiZap, FiShield } from 'react-icons/fi';
...
const navItems = [
  ...
  { path: '/bulk', label: 'Bulk Operations', icon: FiZap },
  { path: '/admin-panel', label: 'Admin Panel', icon: FiShield },
